				...
				<div class="modal-content  bg-dark">
					...
					<form>
						<div class="modal-body">
							<div class="mb-3">
								<input type="file" class="form-control" id="foto_user" required>
							</div>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-outline-light" data-bs-target="#staticBackdrop" data-bs-toggle="modal">Kembali</button>
							<a href="#">
