   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="d-flex" role="search">
     <div class="nav-item dropdown">
      <button class="btn btn-outline-light" style="padding-top: 9px; margin-right: 7.5px;" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="modal-content  bg-dark">
     ...
     <form action="#">
      ...
      <div class="modal-footer">
       <button class="btn btn-outline-light" data-bs-target="#staticBackdrop" data-bs-toggle="modal">Kembali</button>
       <a href="#">
        <button class="btn btn-outline-light" type="submit" data-bs-target="#staticBackdrop" data-bs-toggle="modal">Simpan</button>
       </a>
      </div>
     </form>
    </div>
   ...
   <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="modal-footer bg-dark">
      ...
      <a href="<?= base_url('LoginController/logOut'); ?>"><button type="button" class="btn btn-outline-light">Ya</button></a>
     </div>
    </div>
   </div>
  </div>
